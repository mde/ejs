...
try {
  ...
  exports.lruAvailable = true;
} catch (e) {
  exports.lruAvailable = false;
  // Stub for lru-cache for the browser. lru-cache is not bundled because of
  // concerns over size.
  LRU = function () {
    return new function () {
      this._cache = {};
...
exports.cacheSize = _DEFAULT_CACHE_SIZE;
...
exports.clearCache = function () {
  // Don't use cache.reset() as we want to be able to change cache size after
  // a clear.
  cache = null;
};
