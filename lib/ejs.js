...
, generateSource: function () {
    ...
    if (matches && matches.length) {
      if (this.opts.compileDebug && this.opts.filename) {
        ...
        if (Array.isArray(this.opts.filename)) {
          this.source += '    ; __filenames = ' + JSON.stringify(
            this.opts.filename.map(function(filename) {
                return filename.replace(/\\/g,  '/');
              })
            ) + '\n';
        } else if (typeof this.opts.filename.replace == 'function') {
