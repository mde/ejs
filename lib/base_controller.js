...
var BaseController = function () {
  ...
  this.name = null;
  /**
    @name BaseController#respondsWith
    @public
    @type Array
  ...
  this.content = '';
  /**
    @name BaseController#format
    @public
    @type {String}
    @description Determined by what format the client requests, and if the
    controller/action supports it. Built-in formats can be found in the static
    BaseController.formats
   */
  this.format = '';
  /**
    @name BaseController#contentType
    @public
    @type {String}
  ...
  this.contentType = '';
  /**
    @name BaseController#beforeFilters
    @public
    @type {Array}
  ...
  this.beforeFilters = [];
  /**
    @name BaseController#afterFilters
    @public
    @type {Array}
...
/**
  @name BaseController.formatters
  @static
  @namespace
  @description Contains the static methods for returning data in a specific
  format.
 */
BaseController.formatters = new (function () {

  /**
    @name BaseController.formatters.json
    @static
    @function
  ...
  /**
    @name BaseController.formatters.js
    @static
    @function
  ...
  /**
    @name BaseController.formatters.txt
    @static
    @function
  ...
  /**
    @name BaseController.formatters.html
    @static
    @function
...
BaseController.prototype = new (function () {
  ...
  // -------------------
  /**
    @name BaseController#before
    @public
    @function
    @description Adds an action to the beforeFilters list.
    @param filter {Function} Action to add to the beforeFilter list of
  ...
  /**
    ...
    @param target {String|Object} Either an URL, or an object literal containing
  ...
  /**
    ...
    @param err {Object} The error to use as the basis for the response.
   */
  ...
  /**
    ...
    @param [format] {String} The desired format for the response.
   */
  this.respond = function (content, format) {
    ...
    if (typeof c != 'string') {
      if (this.format) {
        c = BaseController.formatters[format](data, this);
      }
