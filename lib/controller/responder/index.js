...
Responder.prototype = new (function () {
  ...
  */
  this.respond = function (controller, content, opts) {
    ...
    // If there are strategies explicitly passed in in the opts,
    // those are the supported formats -- otherwise used those declared
    // for the controller
    this.formats = opts.strategies ? Object.keys(opts.strategies) :
        (controller.respondsWith || controller.formats);
    ...
    negotiator = new Negotiator(this.controller.request.headers.accept,
        this.formats, controller.params.format);
