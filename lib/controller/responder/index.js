...
Responder.prototype = new (function () {
  ...
  */
  ...
  this.formats = controller.formats ||
      // Backward compat
      controller.respondsWith;
  ...
  */
  this.respondTo = function (content, opts) {
    opts = opts || {}
    ...
    if(typeof strategies[negotiated.format] === 'function') {
      ...
      //The default action is to use 'all'
  ...
  *     is the response buffer
  */
  this.outputFormattedContent = function (content, options, cb) {
    var self = this
      , opts = options || {}
    ...
    response.formatContent(opts.format, content, this.controller, opts, formatCb);
  };
});
