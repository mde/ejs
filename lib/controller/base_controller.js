...
controller.BaseController.prototype = new (function () {
  ...
  */
  ...
  // TODO: Deprecate? Between respondTo and respondWith
  ...
  */
  this.respond = function (content, opts) {
    ...
    if(!options.format) {
      utils.mixin(options, this.responder.negotiate());
    }
  ...
  */
  this.respondWith = function (content, opts) {
    this.handleWithResponder(content, opts);
  };
  ...
  */
  this.respondTo = function (strategies) {
    this.handleWithResponder(null, {
      strategies: strategies
    });
  };

  this.handleWithResponder = function (content, opts) {
