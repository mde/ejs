...
controller.BaseController.prototype = new (function () {
  ...
  */
  this.respond = function (content, options) {
    var self = this
      ...
      , negotiated = this.responder.negotiate(formatParam)
      , format
      , contentType
      , callback;
  ...
  */
  this.respondWith = function () {
    // Delegate to responder
    this.responder.respondWith.apply(this.responder, arguments);
  };
  ...
  */
  this.respondTo = function () {
    // Delegate to responder
    this.responder.respondTo.apply(this.responder, arguments);
  };
