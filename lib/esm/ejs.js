...
// Shims for file/dir in ESM -- do not alter the code below, it generates code
// that has to be removed in the CJS build by string replacement
...
/** @type {string} */
let _VERSION_STRING = pkg.version;
