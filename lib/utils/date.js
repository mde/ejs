  ...
  this.relativeTime = function (dt) {
    ...
    switch (true) {
      ...
      case diff < (2*hour):
        ...
        break;
      case diff < (1*day):
        ret = 'about ' + parseInt((diff / hour), 10) + ' hours ago';
        break;
      case diff < (2*day):
        ret = 'one day ago';
        break;
      case diff < (7*day):
        ret = 'about ' + parseInt((diff / day), 10) + ' days ago';
        break;
      case diff < (8*day):
        ret = 'one week ago';
        break;
      case diff < (1*month):
        ret = 'about ' + parseInt((diff / week), 10) + ' weeks ago';
        break;
      default:
        ret = parseInt((diff / day), 10) + ' days ago';
        break;
    }
    return ret;
  };
