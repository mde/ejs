...
exports.create = function (options) {
  ...
  var controllerName = options.controller
    , controllerNameSingular = utils.inflection.singularize(controllerName)
    , idActions = ['show', 'edit']
    , name, action;
  ...
  switch (options.action) {
    case 'index':
      // neilPeartsPath
      name = utils.string.decapitalize(controllerName) + 'Path';
      break;
    case 'add':
      // addNeilPeartPath
      name = 'add' + controllerNameSingular + 'Path';
      break;
    case 'show':
      // neilPeartPath
      name = utils.string.decapitalize(controllerNameSingular) + 'Path';
      break;
    case 'edit':
      // editNeilPeartPath
      name = 'edit' + controllerNameSingular + 'Path';
      break;
    default:
      // No default
  }
