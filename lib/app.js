...
var App = function () {
  ...
  // Load Model Adapters
  // ==================
    , _registerModelAdapters = function (next) {
      // placeholder for now
    }
      ...
      if (router) {
        ...
        resp.addListener('finish', function () {
          ...
          if (geddy.config.metrics) {
            ...
            controllerActionTimers[controllerName][actionName] = controllerActionTimers[controllerName][actionName] || new geddy.metrics.Timer(controllerName + '.' + actionName)
