...
var App = function () {
  ...
  // ================================================
    ...
    , initBodyParse = function (params, reqObj, cb) {
        var body = ''
          , bodyParams
  ...
  this.start = function (callback) {
    ...
    geddy.server.addListener('request', function (req, resp) {
      ...
      dmn.run(function () {
        ...
        // Try to match a route/method
        params = getParams(self.router, reqUrl, method);
        if (params) {

          enhanceParams(params, urlParams, reqObj, finish);
          ...
          if (controllerInst) {
            ...
            if (params.action == 'destroy' &&
                typeof controllerInst[params.action] != 'function') {
